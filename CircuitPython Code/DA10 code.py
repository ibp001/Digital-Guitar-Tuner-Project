...
# Variable to choose whether to read temperature and humidity data from the sensor or from Thingspeak.
# Choose "sensor" or "thinkspeak".
...
while True:
    if data_source == "thingspeak":
        ...
        x = aht20.temperature
        print("The AHT20 sensor temperature right now is ", x, "°C.")
        #time.sleep(1)
        y = aht20.relative_humidity
        print("The AHT20 sensor RH right now is ", y, "%.")
        #time.sleep(1)
    ...
    if blinkrate > 0:
        # Blinks twice at designated blinkrate before moving on and reading the weather data
        ...
        pixel.show()
        time.sleep(blinkrate)
        print("blinkrate =",blinkrate,"and i=",i," and module3 output=",module3_funcs.wheel(i-1))
